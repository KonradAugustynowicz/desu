...
public class DesCryptor {
    ...
    public void setKey(String key) {
        this.key = key;
        if (key.length()%64==0) this.key = key;
        else {
    ...
    public void setMessage(String message) {
        if (message.length()%64==0) this.message = message;
        else {
    ...
    public static void main(String[] args) {
        DesCryptor DES = new DesCryptor();
        DES.setMessage("1011101010101010101010101010101010101010101010101010101010101010");
        DES.setKey("1011101010101010101010101010101010101010101010101010101010101010");
